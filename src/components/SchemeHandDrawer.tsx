                    ...
                    >
                      ...
                      <div className="pt-2 border-t border-slate-700/40 flex items-center justify-between gap-2 mt-auto">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          {currentPhase === 'scavenge' && card.timing === 'scavenge' && (
                            <button
                              type="button"
                          ...
                          {currentPhase === 'resolution' && card.timing === 'resolution' && (
                            <button
                              type="button"
                          ...
                          {(!isPlayableNow || card.timing !== currentPhase) && (
                            <button
                              type="button"
                              onClick={() => setModalCardId(cardId)}
                              className="px-2 py-1 rounded text-[10px] text-slate-400 hover:text-slate-200 bg-[#162132] hover:bg-[#203048]"
                            >
                              Inspect
                            </button>
                          )}
